...
index_train <- sample(1:N, N/2)

write_parquet(bills_final[index_train, ],
              "data/legislation/govinfo/bills_train.parquet")

write_parquet(bills_final[-index_train, ],
              "data/legislation/govinfo/bills_test.parquet")
```
